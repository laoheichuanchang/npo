...
import com.kft.npo.constants.enums.UserStatusEnums;
import com.kft.npo.dao.SysUserMapper;
import com.kft.npo.dao.SysUserRoleRelMapper;
...
public class UserServiceImpl extends BaseServiceImpl<SysUser> implements IUserService {
	...
	@Value("${kft.user.default.password}")  
